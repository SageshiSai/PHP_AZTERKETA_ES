...
class Vista {
        ...
        ?>
         <form method="POST" action="../Controller/Controller.php">
            <div >
                ...
                <input type="submit" name="Darse_de_alta" value="Enviar" /> 
            </div>
        </form>
        <?php
    }
    ...
    public function cambiarContra() {
        ...
        <form method="POST" action="../Controller/Controller.php">
            <div>
                ...
                <input type="submit" name="Cambiar_pass" value="Enviar" /> 
            </div>
        </form>
        <?php
    }
    ...
    public function area_usuario_admin(){
        ...
        <form method="POST" action="../Controller/Controller.php">
            <input type="submit" name="Productos" value="Crear Producto" />
            <input type="submit" name="Pedidos" value="Mostrar Pedidos" /> 
        </form>
